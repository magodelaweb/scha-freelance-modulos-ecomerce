...
<tr>
   	<td class='titulo' colspan="2" >
        <div class="formtitulo">Nuevo Video</div>
...
<tr>
	<td class='colgrishome' colspan="2">
        <textarea name="resumen"  rows="3" class="area700"></textarea>
	</td>
</tr>
<tr>
	<td class='colgrishome' colspan="2"  align="center">
        Imagen Video : <input type="text" name="imagen" id="imagen" size="80"  maxlength="150" class="box400"><input type="button" value="Seleccionar" onClick="openAsset('imagen')" id="btnAsset" name="btnAsset" > 
	</td>
</tr>
<tr>
	<td class='colgrishome' colspan="2"  align="center">
        Video: <input type="text" name="video" id="video" size="80"  maxlength="150" class="box400">
