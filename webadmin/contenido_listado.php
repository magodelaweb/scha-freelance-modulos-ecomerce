...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="tableborder" >
	<tr >
		...
		<td class='titlecen' >Articulo</td>
		<td class='titlecen' width="150" >Seccion</td>
		<td class='titlecen' width="80" >Visitas</td>
		<td class='titleend'  align="center" colspan="5"  >Opciones</td>
	</tr>
<?php
if ($total == 0)
	{
	...
	while($row = db_fetch_array($sql))
		{
			...
			if ($row['ctipcontenido']=='1') $fileedit ='contenidoedit.php';
			...
			<tr>
                ...
                <td class='colblancocen' valign="top" ><a href="contenidoedit.php?IDpro=<?=$row['ccodcontenido']?>"><?=$row['cnomcontenido']?></a></td>
	...
	?>
	<tr>
   		<td colspan='9' class='formpie' ><?php
...
$(document).ready(function(){
	$("#pg").change(function(){
		$.post("contenido_listado.php",{ idbuscar:'1',idpagina:$("#pg").val(),modulo:$("#modulo").val(),page:$('#selectpage').val(),idpalabra:$("#palabra").val(),codigo:$("#codigo").val(),idfecha:$("#fecha").val(),idseccion:$("#selectseccion").val(),iditems:$("#nroitems").val()},function(data){$("#listado").html(data);})
	});
