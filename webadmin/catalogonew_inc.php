...
while($row1 = db_fetch_array($sqlsec1)) {
			...
			echo '<input type="checkbox" name="select'.$cod1.'" id="select'.$cod1.'"/>'.$row1['cnomseccion'].'<br/>';
}
?>
<!--</select>-->
    </td>
...
<tr>
	<td class='titlehome' colspan="2">Catalogo</td>
</tr>        
<tr>
...
<tr>
	...
	<td class='colblancoend' >
		...
		<input name='selectestilo' checked type='radio' value='1201'/>
	</td>
</tr>
<!--<tr>
