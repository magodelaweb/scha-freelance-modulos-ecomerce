...
{	if(ereg("^[a-zA-Z·ÈÌÛ˙Ò—\ ]+$",$cadena))	return true;
	else 								return false;
}
...
{	if(ereg("^[a-zA-Z0-9·ÈÌÛ˙Ò—\@\_\,\.\:\ \?\-]+$",$cadena))	return true;
	else 								return false;
}
function validar_direccion($cadena)
{	if(ereg("^[a-zA-Z0-9·ÈÌÛ˙Ò—\,\.\ \-]+$",$cadena))	return true;
	else 								return false;
}
...
{	if(ereg("^[a-zA-Z·ÈÌÛ˙Ò—0-9\ \_]+$",$cadena))	return true;
	else 								return false;
}
...
//Traduzco los meses de ingles a EspaÒol
