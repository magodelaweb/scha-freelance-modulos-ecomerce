...
if(isset($_FILES["File1"]))
  {
	$nomimagen1 = strtolower(basename($_FILES['File1']['name']));
  ...
  if($MaxFileSize && ($_FILES['File1']['size'] > $MaxFileSize))
    ...
    {
    $sMsg = "Solo se Aceptan Imagenes JPG y PNG.";
    }
...
<td valign=top style="height:100%;background:url('bg.gif') no-repeat right bottom;padding-top:5px;padding-left:5px;padding-right:5px;padding-bottom:0px;">
    ...
    <td valign=top align="center">
        ...
        <tr>
        <td>
          <div id="idPreview" style="text-align:center;overflow:auto;width:287px;height:245px;border:#d7d7d7 5px solid;border-bottom:#d7d7d7 3px solid;background:#ffffff;margin-right:2;"></div>
