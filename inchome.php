...
<div style="width:711px;">
	   <div style="clear:both; overflow:hidden;">
		...
		while($info=$aclass->respuesta()){
			...
			echo '<div class="celda left" '.((($i%4)==0)?'style="margin-right:0;"':'').'><div class="celdacont"><a class="segura" href="'.CodificaUrlImg($nomurl.$info[2]).'"><img class="segura" src="'.CodificaUrlImg(str_replace('fotos','thumbs',substr($info[6],1))).'"  width="'.(40+(40*3)).'"  height="'.(30+(30*3)).'"/></a><p>'.$info[1].'</p></div></div>';
			$i++;
		}
		?>
		</div>
